...
class Enumeration:
    ...
    def __init__(self, pt: PT_uint32, enum_name: str, enums: dict[str, int]) -> None: ...
...
class MessageFormat:
    ...
    def __init__(self, msgid_bytes: bytes, msgformat: str, enumerations: dict[str, dict[str, int]] = {}) -> None: ...
...
class MessageParser:
    ...
    def create_dummy_response(self, msgname: str, params: dict[str, Any] = {}) -> bytes: ...
    ...
    class sentinel: ...
    @overload
    def get_constant(self, name: str, default: type[sentinel] = ..., parser: Callable[[str], _U] = ...) -> _U: ...
    @overload
    def get_constant(self, name: str, default: _T, parser: Callable[[str], _U] = ...) -> _U | _T: ...
    @overload
