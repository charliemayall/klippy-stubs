...
def multi_complete(
    printer: Printer, completions: list[ReactorCompletion]
) -> ReactorCompletion: ...
...
class HomingMove:
    ...
    def calc_toolhead_pos(
        self, kin_spos: dict[str, float], offsets: dict[str, int]
    ) -> list[float]: ...
    def homing_move(
        self,
        movepos: list[float],
...
class Homing:
    ...
    def home_rails(
        self, rails, forcepos: list[float], movepos: list[float]
    ) -> None: ...
