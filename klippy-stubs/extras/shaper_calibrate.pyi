...
class ShaperCalibrate:
    ...
    def fit_shaper(self, shaper_name, calibration_data, shaper_freqs, damping_ratio, scv, max_smoothing, max_vibrations, test_damping_ratios, max_freq): ...
    def find_shaper_max_accel(self, shaper, scv): ...
    def find_best_shaper(self, calibration_data, shapers=None, damping_ratio=None, scv=None, shaper_freqs=None, max_smoothing=None, max_vibrations=None, test_damping_ratios=None, max_freq=None, logger=None): ...
    ...
    def save_calibration_data(self, output, calibration_data, shapers=None, max_freq=None) -> None: ...
