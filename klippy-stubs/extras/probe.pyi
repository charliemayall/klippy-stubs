...
class ProbeCommandHelper:
    ...
    def __init__(self, config: configfile.ConfigWrapper, probe: PrinterProbe, query_endstop=None, can_set_z_offset: bool = True) -> None: ...
...
class HomingViaProbeHelper:
    ...
    def home_start(self, print_time: float, sample_time: float, sample_count: int, rest_time: float, triggered: bool = True) -> NoReturn: ...
...
class DescendToEndstopHelper:
    ...
    def __init__(self, config: configfile.ConfigWrapper, mcu_probe, probe_offsets, param_helper, always_check_movement: bool = False) -> None: ...
...
class SampleAveragingHelper:
    ...
    results: list[tuple[float, float, float]]
    def __init__(self, config: configfile.ConfigWrapper, param_helper: ProbeParameterHelper, start_session_cb) -> None: ...
...
class ProbePointsHelper:
    ...
    def __init__(self, config: configfile.ConfigWrapper, finalize_callback, default_points: list[tuple[float, float]] | None = None) -> None: ...
    def minimum_points(self, n: int) -> None: ...
    def update_probe_points(self, points: list[tuple[float, float]], min_points: int) -> None: ...
...
class ProbeEndstopWrapper:
    ...
    multi: str
    def __init__(self, config: configfile.ConfigWrapper, probe_offsets: ProbeOffsetsHelper, param_helper: ProbeParameterHelper) -> None: ...
