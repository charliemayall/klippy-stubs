...
class WebRequest:
    ...
    @overload
    def get(self, item: str, default: type[Sentinel] = ..., types: tuple[type, ...] | None = None) -> Any: ...
    @overload
    def get(self, item: str, default: _T, types: tuple[type, ...] | None = None) -> Any | _T: ...
    @overload
...
class ClientConnection:
    ...
    def set_client_info(self, client_info: str, state_msg: str | None = None) -> None: ...
    def close(self) -> None: ...
